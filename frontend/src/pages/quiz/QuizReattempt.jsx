    ...
    <div className="min-h-screen bg-gradient-to-br from-dark-950 via-dark-900 to-dark-850">
      <div className="max-w-2xl mx-auto px-4 py-10">
        <div className="card text-center">
          ...
          <h1 className="text-2xl font-bold text-white mb-2">Your quiz was interrupted.</h1>
          ...
          <div className="card-solid text-left mb-6">
            ...
            <div className="text-xs text-gray-500 mt-1">Remaining attempts: {remainingAttempts}</div>
          </div>
      ...
      <MascotGuide emoji="🔁" message="Second try — improvement matters!" position="bottom-right" />
    </div>
  );
};
